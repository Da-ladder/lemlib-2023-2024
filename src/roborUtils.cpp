...
bool MotorUtils::checkGroupTemps() {
  ...
  // Loops through the vectors (or lists) to check to see if any of them are at
  // or above the temp_flag limit If so, the function will return true and the
  // user determines what to do next
